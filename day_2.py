...
file_name = input('What is your password file name? (file has to be in the data folder) \n')
old_company_valids, new_company_valids = valid_passwords(f'data/{file_name}.txt')
